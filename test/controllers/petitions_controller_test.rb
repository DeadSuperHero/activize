...
class PetitionsControllerTest < ActionController::TestCase
  ...
  test "should create petition" do
    assert_difference('Petition.count') do
      post :create, petition: { cover: @petition.cover, description: @petition.description, signum: @petition.signum, target: @petition.target, title: @petition.title }
    end
  ...
  test "should update petition" do
    patch :update, id: @petition, petition: { cover: @petition.cover, description: @petition.description, signum: @petition.signum, target: @petition.target, title: @petition.title }
    assert_redirected_to petition_path(assigns(:petition))
  end
